              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-b border-zinc-200">
                <div className="p-4 mb:p-6 border-t border-r border-zinc-200">
                  ...
                  <p className={`text-[#676C6C] text-sm md:text-base`}>
                    We prioritize your business goals and user needs, not
                    internal processes or unnecessary technical complexity.
                  </p>
                </div>
                ...
                <div className="p-4 mb:p-6 border-t border-zinc-200">
                  ...
                  <p className={`text-[#676C6C] text-sm md:text-base`}>
                    Clear scope, structured sprints, and realistic timelines
                    help us deliver quickly without sacrificing quality.
                  </p>
                </div>
                ...
                <div className="p-4 mb:p-6 border-t border-r border-zinc-200">
                  ...
                  <p className={`text-[#676C6C] text-sm md:text-base`}>
                    You work directly with designers and developers, with
                    regular updates and zero unnecessary back-and-forth.
                  </p>
                </div>
