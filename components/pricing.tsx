          ...
          >
            <div className="border-x border-zinc-200">
              <div className="flex flex-col md:flex-row">
                <div className="p-4 md:p-5 md:border-r border-zinc-200">
                ...
                <div className="p-4 md:p-5 md:border-r border-zinc-200 bg-[#040E0E] text-white">
                ...
                <div className="p-4 md:p-5">
                  <div className="border-b border-zinc-200">
                    ...
                    <p className="text-sm text-[#676C6C] my-2">
                      Founders and teams who need a long-term product, design,
